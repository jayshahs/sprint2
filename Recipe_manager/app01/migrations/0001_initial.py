# Generated by Django 4.0.5 on 2022-08-07 13:27
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('aux1', models.CharField(default='Salt', max_length=16, verbose_name='aux')),
                ('quantity', models.IntegerField(default=1, verbose_name='Amount')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('aux2', models.CharField(default='Salt', max_length=16, verbose_name='aux')),
                ('quantity', models.IntegerField(default=1, verbose_name='Amount')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('meat1', models.CharField(default='Chicken', max_length=16, verbose_name='Meat')),
                ('quantity', models.IntegerField(default=1, verbose_name='Amount')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('veg1', models.CharField(default='coriander', max_length=16, verbose_name='vegetable')),
                ('quantity', models.IntegerField(default=1, verbose_name='Amount')),
            ],
        ),
        migrations.CreateModel(
